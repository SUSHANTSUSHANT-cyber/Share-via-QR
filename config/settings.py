"""Application configuration loader for the AISIN Secure File Transfer.
...
def build_settings() -> Settings:
    ...
    settings_values: dict[str, Any] = {
        "app_name": os.getenv("APP_NAME", "AISIN Secure File Transfer"),
        "app_version": os.getenv("APP_VERSION", "0.2.0"),
        "host": os.getenv("HOST", "0.0.0.0"),
        "port": _as_int(os.getenv("PORT"), 9000),
